...
Quad.rot_rad = .11;   %Radius of the propellor (m)
...
Quad.Jx = .024;     % Moment of inertia about X axis (kg-m^2)
Quad.Jy = .024;     % Moment of inertia about Y axis (kg-m^2)
Quad.Jz = .02;    % Moment of inertia about Z axis (kg-m^2)
...
Quad.x_acc_bias = 0.1423933058977127;  % m/s^2
Quad.x_acc_sd = 0.001233586110174656;
Quad.y_acc_bias = 0.31691;  % m/s^2
Quad.y_acc_sd = -0.002350092865526676;
Quad.z_acc_bias = -2.087857723236084;  % m/s^2
Quad.z_acc_sd = 0.0009011079091578722;

Quad.x_gyro_bias = -0.029037127800091235702;  % rad/s
Quad.x_gyro_sd = 0.00066675;
Quad.y_gyro_bias = -0.0064391547304024866413;  % rad/s
Quad.y_gyro_sd = 0.00053642;
Quad.z_gyro_bias = 0.00124686679516246160328;  % rad/s
...
Quad.min_pwm = 700;
Quad.max_pwm = 2000;
Quad.max_power = 240; % Watt
Quad.max_amp = 12; % Ampere
Quad.max_volt = Quad.max_power / Quad.max_amp; % Volt
Quad.kV = 2450; % RPM/V
Quad.hover_throttle = 1400;
Quad.motor_efficiency = 0.8; 
Quad.KT = Quad.m * Quad.g / 4 / (Quad.kV * Quad.hover_throttle / Quad.max_pwm * Quad.motor_efficiency * 0.104719755).^2;    % Thrust force coeffecient (kg-m)
Quad.Jp = 0.044;     % Moment of Intertia of the rotor (kg-m^2)
Quad.max_motor_speed = Quad.max_volt * Quad.motor_efficiency * Quad.kV * 0.104719755; % motors upper limit (rad/s)
